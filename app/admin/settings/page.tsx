    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('general', 'maintenanceMode', value)}
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('notifications', 'emailNotifications', value)}
        />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'userRegistrations', value)}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'courseSubmissions', value)}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'paymentNotifications', value)}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'systemAlerts', value)}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'weeklyReports', value)}
          />
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <Switch
            ...
            onCheckedChange={(value) => handleInputChange('notifications', 'mentorApplications', value)}
          />
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('security', 'twoFactorAuth', value)}
        />
      </div>
      ...
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('security', 'requireStrongPassword', value)}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={(e) => handleInputChange('security', 'ipWhitelist', e.target.value.split(',').map(ip => ip.trim()))}
    ...
    <div className="space-y-6">
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => handleInputChange('payment', 'currency', value)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('payment', 'platformFee', parseFloat(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('payment', 'payoutThreshold', parseInt(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => handleInputChange('payment', 'payoutSchedule', value)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
      ...
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('payment', 'autoApprovePayouts', value)}
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('courses', 'autoApproveCourses', value)}
        />
      </div>

      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <Label htmlFor="maxCourseDuration">Maksimal Durasi Kursus (bulan)</Label>
          <Input
            id="maxCourseDuration"
            type="number"
            value={formData.courses.maxCourseDuration}
            onChange={(e) => handleInputChange('courses', 'maxCourseDuration', parseInt(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('courses', 'minCoursePrice', parseInt(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('courses', 'maxCoursePrice', parseInt(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange('courses', 'defaultCommission', parseInt(e.target.value))}
          />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <Switch
          ...
          onCheckedChange={(value) => handleInputChange('courses', 'allowCoursePreviews', value)}
        />
      </div>
    </div>
  );
                ...
                <div className="flex gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                  ...
                  {!hasChanges && (
                    <div className="flex items-center gap-2 text-[#008A00]">
                      ...
                      <span className="text-sm">Semua perubahan telah disimpan</span>
                    </div>
                  )}
                </div>
              </CardContent>
