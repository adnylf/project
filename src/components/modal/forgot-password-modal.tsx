      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          <CardContent className="p-5 space-y-5">
            {/* Bagian Konfirmasi Email - compact */}
            <div>
              ...
              <Card className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                <CardContent className="p-3">
                  <div className="mb-2">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Email yang dituju</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
                <Card className="rounded-md border border-gray-200 dark:border-gray-700">
                  <CardContent className="p-2.5">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white mb-0.5">Periksa Spam/Junk</p>
                ...
                <Card className="rounded-md border border-gray-200 dark:border-gray-700">
                  <CardContent className="p-2.5">
                    <div className="flex items-start gap-2">
                      <div className="p-1 bg-orange-50 dark:bg-orange-900/20 rounded-md flex-shrink-0 mt-0.5">
                        <Clock className="w-3 h-3 text-orange-600 dark:text-orange-400" />
                      </div>
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white mb-0.5">Link kadaluarsa</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">
                          Berlaku 24 jam dari waktu pengiriman
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="rounded-md border border-gray-200 dark:border-gray-700">
                  <CardContent className="p-2.5">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white mb-0.5">Tidak menerima?</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400">
