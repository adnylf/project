...
const courseData = {
  ...
  shortDescription:
    "Pelajari fundamental pemrograman web modern dengan teknologi terkini",
  fullDescription:
    "Kursus ini akan mengajarkan Anda dasar-dasar pemrograman web mulai dari HTML, CSS, hingga JavaScript. Anda akan belajar membuat website responsif dan interaktif dari nol.",
  ...
  const accessibilityOptions = [
    {
      key: "subtitles",
      label: "Subtitle",
      description: "Subtitle untuk video",
    },
    {
      key: "transcripts",
      label: "Transcript",
      description: "Transkrip teks materi",
    },
    {
      key: "signLanguage",
      label: "Bahasa Isyarat",
      description: "Video bahasa isyarat",
    },
    {
      key: "highContrast",
      label: "Kontras Tinggi",
      description: "Tampilan kontras tinggi",
    },
    {
      key: "adjustableSpeed",
      label: "Kecepatan Variabel",
      description: "Kontrol kecepatan pemutaran",
    },
  ];
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card className="rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 hover:shadow-md border-gray-200 dark:border-gray-700 animate-fadeSlide delay-100">
              <CardHeader>
                ...
                <CardDescription>
                  Upload atau ubah gambar yang akan ditampilkan sebagai
                  thumbnail kursus
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {thumbnailPreview ? (
                  ...
                  <div
                    className="flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-12 cursor-pointer hover:border-[#005EB8] transition-colors"
                    onClick={() =>
                      document.getElementById("thumbnail-upload")?.click()
                    }
                  >
                  ...
                  {accessibilityOptions.map((option) => (
                    ...
                    >
                      <input
                        ...
                        id={option.key}
                        checked={
                          (formData.accessibilityFeatures as any)[option.key]
                        }
                        onChange={(e) =>
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <Check
                      className={`h-5 w-5 flex-shrink-0 mt-0.5 ${
                        formData.title ? "text-[#008A00]" : "text-gray-300"
                      }`}
                    />
                    <span
                      className={
                  ...
                  <li className="flex items-start gap-2">
                    <Check
                      className={`h-5 w-5 flex-shrink-0 mt-0.5 ${
                        formData.category ? "text-[#008A00]" : "text-gray-300"
                      }`}
                    />
                    <span
                      className={
                  ...
                  <li className="flex items-start gap-2">
                    <Check
                      className={`h-5 w-5 flex-shrink-0 mt-0.5 ${
                        formData.price ? "text-[#008A00]" : "text-gray-300"
                      }`}
                    />
                    <span
                      className={
                  ...
                  <li className="flex items-start gap-2">
                    <Check
                      className={`h-5 w-5 flex-shrink-0 mt-0.5 ${
                        thumbnailPreview ? "text-[#008A00]" : "text-gray-300"
                      }`}
                    />
                    <span
                      className={
